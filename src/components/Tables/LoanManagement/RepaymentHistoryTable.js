...
import { MOCK_DUMMY_MEMBER_REPAYMENT_HISTORY } from "../../DummyData";
...
const RepaymentHistoryTable = () => {
  ...
  const data = useMemo(() => MOCK_DUMMY_MEMBER_REPAYMENT_HISTORY, []);
      ...
      {transactionData?.length > 0 ? (
        <div>
          <p className="text-[#1D0218] text-sm font-bold mb-4">
            Showing 1 - 50 of 100 Loan Repayment
          </p>
        ...
        <EmptyState
          title={"You have no Repayment History"}
          subTitle={
