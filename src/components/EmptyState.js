...
const EmptyState = ({ title, buttonTitle, icon, subTitle, onClick,beneficiariesModal }) => {
  return (
    <div className={`flex flex-col  p-4 justify-center items-center w-full ${beneficiariesModal ? "h-96" : "h-screen bg-white"}`}>
